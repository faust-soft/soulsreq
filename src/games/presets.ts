...
export const PRESETS: Record<string, Preset[]> = {
  ...
  DS2: [
    { name: "Warrior",   stats: { str: 15, dex: 11, int: 5,  fth: 5 } },
    { name: "Knight",    stats: { str: 11, dex: 8,  int: 3,  fth: 6 } },
    { name: "Swordsman", stats: { str: 9,  dex: 16, int: 7,  fth: 5 } },
    { name: "Bandit",    stats: { str: 9,  dex: 14, int: 1,  fth: 8 } },
    { name: "Cleric",    stats: { str: 11, dex: 5,  int: 4,  fth: 12 } },
    { name: "Sorcerer",  stats: { str: 3,  dex: 7,  int: 14, fth: 4 } },
    { name: "Explorer",  stats: { str: 6,  dex: 6,  int: 5,  fth: 5 } },
    { name: "Deprived",  stats: { str: 6,  dex: 6,  int: 6,  fth: 6 } },
  ],
  DS3: [
    { name: "Knight",     stats: { str: 13, dex: 12, int: 9,  fth: 9 } },
    { name: "Mercenary",  stats: { str: 10, dex: 16, int: 10, fth: 8 } },
    { name: "Warrior",    stats: { str: 16, dex: 9,  int: 8,  fth: 9 } },
    { name: "Herald",     stats: { str: 12, dex: 11, int: 8,  fth: 13 } },
    { name: "Thief",      stats: { str: 9,  dex: 13, int: 10, fth: 8 } },
    { name: "Assassin",   stats: { str: 10, dex: 14, int: 11, fth: 9 } },
    { name: "Sorcerer",   stats: { str: 7,  dex: 12, int: 16, fth: 7 } },
    { name: "Pyromancer", stats: { str: 12, dex: 9,  int: 14, fth: 14 } },
    { name: "Cleric",     stats: { str: 12, dex: 8,  int: 7,  fth: 16 } },
    { name: "Deprived",   stats: { str: 10, dex: 10, int: 10, fth: 10 } },
  ],
  BB:  [
